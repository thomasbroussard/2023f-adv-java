...
public class PatientDAODerbyImpl implements IPatientDAO {

    private static final String JDBC_URL = "jdbc:derby:memory:medicalDB;create=true";
    private static final String JDBC_USER = "";
    private static final String JDBC_PASSWORD = "";

    public PatientDAODerbyImpl() throws Exception {
